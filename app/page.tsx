    ...
    <div className="bg-brand-navy pb-16 pt-8 text-white">
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-5 px-4 text-center">
        ...
        <div className="mt-6 grid w-full grid-cols-1 gap-8 text-left sm:grid-cols-2">
          ...
          <Link
            href="/coach2mentor"
            className="flex min-h-[240px] flex-col rounded-2xl border-2 border-white/10 bg-[#BEC4CF] p-8 pt-10 text-brand-navy shadow-xl transition hover:scale-[1.02] hover:brightness-105"
          >
            <h2 className="text-center text-3xl font-bold sm:text-4xl">
        ...
        <p className="mt-2 text-xs text-white/50">
          Shaping Australian football coaches&rsquo; futures
        </p>
      </div>
    </div>
  );
